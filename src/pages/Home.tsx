...
const Home = () => {
    ...
    return (
        ...
        {/* Hero Section */ }
        < section className = "relative min-h-[90vh] flex flex-col items-center justify-center px-6 pt-32 lg:pt-40 overflow-hidden" >
            {/* Interactive Background Tiles */ }
            < div className = "absolute inset-0 z-0" >
                <Tiles tileSize="md" rows = { 40} cols = { 20} className = "opacity-40" />
                    </div>
...
className = "text-center lg:text-left order-2 lg:order-1"
    ...
    <div className="mb-8 hidden lg:block" >
        <img src="/assets/logo.png" alt = "SiaCore Logo" className = "h-24 w-auto object-contain drop-shadow-md" />
            ...
            < span className = "inline-block px-4 py-1 bg-primary/10 text-primary text-[10px] font-bold rounded-full uppercase tracking-[0.2em] mb-6 shadow-sm backdrop-blur-sm" >
    ...
    < h1 className = "text-6xl md:text-8xl font-display font-bold text-gray-900 leading-[0.8] tracking-tighter mb-8" >
        BE BOLD. < br />
            BE < span className = "text-primary italic" > YOU.</span>
                ...
                < p className = "text-gray-500 text-lg mb-10 max-w-md mx-auto lg:mx-0 leading-relaxed font-medium" >
...
className = "relative order-1 lg:order-2"
    ...
    <div className="lg:hidden mb-12 flex justify-center" >
        <img src="/assets/logo.png" alt = "SiaCore Logo" className = "h-40 w-auto object-contain drop-shadow-lg" />
            ...
            < div className = "relative z-10 rounded-[3rem] overflow-hidden aspect-[3/4] shadow-2xl scale-100 hover:scale-[1.02] transition-transform duration-700 bg-white/50 backdrop-blur-sm" >
                <img
...
{/* Categories Grid */ }
<section className="py-24 px-6 bg-accent-nude/20 relative" >
...
<section className="py-24 px-6 relative" >
    <div className="absolute inset-0 z-0 opacity-10 pointer-events-none" >
        <Tiles tileSize="lg" rows = { 20} cols = { 10} />
            </div>
            < div className = "max-w-7xl mx-auto z-10 relative" >
                <div className="flex justify-between items-end mb-12" >
